...
namespace custom {
    ...
    private:
        ...
        void to_string_inorder(node<T>*& anchor, std::string& str) {
            if (!anchor) {
                return;
            }
            to_string_inorder(anchor->left, str);
            str += anchor->data + " ";
            to_string_inorder(anchor->right, str);
        }
        ...
        void to_string_preorder(node<T>*& anchor, std::string& str) {
            if (!anchor) {
                return;
            }
            str += anchor->data + " ";
            to_string_preorder(anchor->left, str);
            to_string_preorder(anchor->right, str);
        }
        ...
        void to_string_postorder(node<T>*& anchor, std::string& str) {
            if (!anchor) {
                return;
            }
            to_string_postorder(anchor->left, str);
            to_string_postorder(anchor->right, str);
            str += anchor->data + " ";
        }
    ...
    public:
        ...
        void to_string(std::string& str, const int MODE = 0) {
            switch (MODE) {
            case 0:
                to_string_inorder(root, str);
                break;
            case 1:
                to_string_preorder(root, str);
                break;
            case 2:
                to_string_postorder(root, str);
                break;
            default:
                break;
            }
