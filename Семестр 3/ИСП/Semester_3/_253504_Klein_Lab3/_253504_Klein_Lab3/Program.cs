...
try
{
    ...
    foreach (var temp in shop.GetSortedItemNameList())
    {
        Console.WriteLine(temp);
    }
    Console.WriteLine(shop.GetSoldItemTotalPrice());
    Console.WriteLine(shop.GetMostValuableClientName());
    Console.WriteLine(shop.GetClientCount(10));
    foreach (var temp in shop.GetTotalOfEachSoldItem())
    {
